...
public class ParameterizedSparqlString implements PrefixMapping {
    ...
    public void appendIri(String uri) {
        this.appendNode(NodeFactory.create(uri));
    }
    ...
    public void appendIri(IRI iri) {
        this.appendNode(NodeFactory.create(iri.toString()));
    }
    ...
    public void appendLiteral(long l) {
        this.appendNode(NodeFactory.intToNode((int) l));
    }
    ...
    public void setIri(int index, String iri) {
        this.setParam(index, NodeFactory.create(iri));
    }
    ...
    public void setIri(String var, String iri) {
        this.setParam(var, NodeFactory.create(iri));
    }
    ...
    public void setLiteral(int index, long l) {
        this.setParam(index, NodeFactory.intToNode((int) l));
    }
    ...
    public void setLiteral(String var, long l) {
        this.setParam(var, NodeFactory.intToNode((int) l));
    }
    ...
    public String toString() {
        ...
        if (this.baseUri != null) {
            ...
            finalCmd.append(FmtUtils.stringForURI(this.baseUri));
            finalCmd.append('\n');
        }
        ...
        while (pre.hasNext()) {
            ...
            finalCmd.append(prefix);
            finalCmd.append(": ");
            finalCmd.append(FmtUtils.stringForURI(this.prefixes.getNsPrefixURI(prefix)));
            finalCmd.append('\n');
        }
...
//    }
    ...
    public String usePrefix(String s) {
        return null;
    }
