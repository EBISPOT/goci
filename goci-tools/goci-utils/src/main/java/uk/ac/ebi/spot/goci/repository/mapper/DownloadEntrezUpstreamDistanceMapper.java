 ...
 */
@Component
public class DownloadEntrezUpstreamDistanceMapper implements CatalogDataMapper {
    ...
    @Override public List<CatalogHeaderBinding> getRequiredDatabaseFields() {
        return Arrays.asList(CatalogHeaderBinding.ENTREZ_MAPPED_GENE,
                             CatalogHeaderBinding.ENTREZ_UPSTREAM_GENE_DISTANCE);
    }

    @Override public CatalogHeaderBinding getOutputField() {
        return CatalogHeaderBinding.DOWNLOAD_ENTREZ_UPSTREAM_GENE_DISTANCE;
    }
    ...
    @Override public String produceOutput(Map<CatalogHeaderBinding, String> databaseValues) {
        ...
        if (mapped.isEmpty()) {
            output = databaseValues.get(CatalogHeaderBinding.ENTREZ_UPSTREAM_GENE_DISTANCE);
        }
        else {
            output = "";
        }
