 ...
 */
public class OWLRenderletNexus implements RenderletNexus {
    ...
    public <O> void renderingEventOccurred(RenderingEvent<O> evt) {
        ...
        // todo - add fragment of SVG that was rendered to our document being constructed
    }
    ...
    // TODO - actual rendering of the SVG needs to happen on the renderlets, we just come to the nexus to get the consolidated view
