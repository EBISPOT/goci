...
(function(global, factory) {
    ...
    if (window.PointerEvent) {
        ...
        hook.props = mouseProps.concat(['touches', 'changedTouches', 'targetTouches', 'altKey', 'ctrlKey', 'metaKey',
                                           'shiftKey']);
    ...
    Matrix.prototype = {
        ...
        determinant: function() {
            var a = this.elements;
            return a[0] * (a[8] * a[4] - a[7] * a[5]) - a[3] * (a[8] * a[1] - a[7] * a[2]) +
                    a[6] * (a[5] * a[1] - a[4] * a[2]);
        }
    };
    ...
    Panzoom.prototype = {
        ...
        setMatrix: function(matrix, options) {
            ...
            if (contain) {
                ...
                if (contain === 'invert') {
                    ...
                    matrix[5] =
                            Math.max(Math.min(matrix[5], marginH - top), -marginH - top - diffH + dims.heightBorder);
                }
                else {
        ...
        _getDistance: function(touches) {
            ...
            return Math.sqrt(Math.pow(Math.abs(touch2.clientX - touch1.clientX), 2) +
