...
+function(a) {
    ...
    d.VERSION = "3.3.1", d.TRANSITION_DURATION = 150, d.prototype.close = function(b) {
        ...
        b && b.preventDefault(), g.length || (g = e.closest(".alert")), g.trigger(b =
                                                                                          a.Event("close.bs.alert")), b.isDefaultPrevented() ||
    ...
    var c = function(b, c) {
        this.$element = a(b), this.$indicators = this.$element.find(".carousel-indicators"), this.options =
                c, this.paused =
                this.sliding = this.interval = this.$active = this.$items = null, this.options.keyboard &&
    ...
    {interval: 5e3, pause: "hover", wrap: !0, keyboard: !0}, c.prototype.keydown = function(a) {
        ...
        var e = this.$element.find(".item.active"), f = d ||
                this.getItemForDirection(b, e), g = this.interval, h = "next" == b ? "left" : "right", i = "next" == b ?
                "first" : "last", j = this;
        if (!f.length) {
        ...
        if (this.$element.trigger(l), !l.isDefaultPrevented()) {
            ...
            return a.support.transition && this.$element.hasClass("slide") ?
                    ...
                    (e.removeClass("active"), f.addClass("active"), this.sliding = !1, this.$element.trigger(n)), g &&
            this.cycle(), this
        }
    };
    var d = a.fn.carousel;
    ...
    function c(b) {
        return this.each(function() {
            var c = a(this), e = c.data("bs.collapse"), f = a.extend({},
                                                                     ...
                                                                     c.data(),
                                                                     "object" == typeof b && b);
            !e && f.toggle && "show" == b && (f.toggle = !1), e ||
    ...
    var d = function(b, c) {
        this.$element = a(b), this.options = a.extend({}, d.DEFAULTS, c), this.$trigger =
                a(this.options.trigger).filter('[href="#' + b.id + '"], [data-target="#' + b.id +
    ...
    {toggle: !0, trigger: '[data-toggle="collapse"]'}, d.prototype.dimension = function() {
        ...
        if (/(38|40|27|32)/.test(b.which) && !/input|textarea/i.test(b.target.tagName)) {
            ...
            if (b.preventDefault(), b.stopPropagation(), !d.is(".disabled, :disabled")) {
                ...
                if (i.length) {
                    ...
                    38 == b.which && j > 0 && j--, 40 == b.which && j < i.length - 1 && j++, ~j ||
    ...
    var c = function(b, c) {
        this.options = c, this.$body = a(document.body), this.$element = a(b), this.$backdrop =
                this.isShown = null, this.scrollbarWidth = 0, this.options.remote &&
    ...
    {backdrop: !0, keyboard: !0, show: !0}, c.prototype.toggle = function(a) {
        ...
        this.$element.trigger(e), this.isShown || e.isDefaultPrevented() || (this.isShown =
            ...
            d.$element.appendTo(d.$body), d.$element.show().scrollTop(0), d.options.backdrop &&
        ...
        !b.isDefaultPrevented() && (this.isShown =
                !1, this.escape(), this.resize(), a(document).off("focusin.bs.modal"), this.$element.removeClass("in").attr(
                "aria-hidden",
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop = a('<div class="modal-backdrop ' + e + '" />').prependTo(this.$element).on(
                            ...
                            a.proxy(function(a) {
                                ...
                                ("static" == this.options.backdrop ? this.$element[0].focus.call(this.$element[0]) :
                                        this.hide.call(this))
        ...
        this.bodyIsOverflowing =
                document.body.scrollHeight > document.documentElement.clientHeight, this.scrollbarWidth =
    ...
    a.fn.modal = b, a.fn.modal.Constructor = c, a.fn.modal.noConflict = function() {
        ...
        var d = a(this), e = d.attr("href"), f = a(d.attr("data-target") ||
                ...
                "toggle" : a.extend({remote: !/#/.test(e) && e}, f.data(), d.data());
    ...
    c.VERSION = "3.3.1", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        return c && c.$tip && c.$tip.is(":visible") ? void(c.hoverState = "in") : (c ||
        ...
        (c = new this.constructor(b.currentTarget, this.getDelegateOptions()), a(b.currentTarget).data("bs." +
                                                                                                       this.type,
                                                                                                       c)), clearTimeout(
                c.timeout), c.hoverState = "out", c.options.delay && c.options.delay.hide ?
                void(c.timeout = setTimeout(function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (j) {
                var n = h, o = this.options.container ? a(this.options.container) :
                        this.$element.parent(), p = this.getPosition(o);
                h = "bottom" == h && k.bottom + m > p.bottom ? "top" : "top" == h && k.top - m < p.top ? "bottom" :
                        "right" == h && k.right + l > p.width ? "left" :
                                "left" == h && k.left - l < p.left ? "right" : h, f.removeClass(n).addClass(h)
            }
            ...
            a.support.transition && this.$tip.hasClass("fade") ?
                    f.one("bsTransitionEnd", r).emulateTransitionEnd(c.TRANSITION_DURATION) : r()
        }
        ...
        return this.$element.trigger(g), g.isDefaultPrevented() ? void 0 :
                (f.removeClass("in"), a.support.transition && this.$tip.hasClass("fade") ?
                        f.one("bsTransitionEnd", d).emulateTransitionEnd(c.TRANSITION_DURATION) : d(), this.hoverState =
                        null, this)
    ...
    c.VERSION = "3.3.1", c.DEFAULTS = a.extend({},
            ...
            a.extend({}, a.fn.tooltip.Constructor.prototype), c.prototype.constructor = c, c.prototype.getDefaults =
            function() {
                return c.DEFAULTS
            }, c.prototype.setContent = function() {
    ...
    function b(c, d) {
        ...
        this.$body = a("body"), this.$scrollElement = a(a(c).is("body") ? window : c), this.options =
                a.extend({}, b.DEFAULTS, d), this.selector =
                (this.options.target || "") + " .nav li > a", this.offsets = [], this.targets = [], this.activeTarget =
                null, this.scrollHeight = 0, this.$scrollElement.on("scroll.bs.scrollspy",
    ...
    c.VERSION = "3.3.1", c.TRANSITION_DURATION = 150, c.prototype.show = function() {
        ...
        function f() {
            g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find(
                    ...
                    "aria-expanded",
                    !0), h ? (b[0].offsetWidth, b.addClass("in")) : b.removeClass("fade"), b.parent(".dropdown-menu") &&
    ...
    var c = function(b, d) {
        this.options = a.extend({}, c.DEFAULTS, d), this.$target =
                a(this.options.target).on("scroll.bs.affix.data-api", a.proxy(this.checkPosition, this)).on(
                        ...
                        a.proxy(this.checkPositionWithEventLoop, this)), this.$element = a(b), this.affixed =
    ...
    a.fn.affix = b, a.fn.affix.Constructor = c, a.fn.affix.noConflict = function() {
        ...
        a('[data-spy="affix"]').each(function() {
            ...
            d.offset = d.offset || {}, null != d.offsetBottom && (d.offset.bottom = d.offsetBottom), null !=
