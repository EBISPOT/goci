...
-- GWASDISEASETRAITS
INSERT INTO GWASDISEASETRAITS (ID, DISEASETRAIT) VALUES (1, 'Systemic lupus erythematosus');
INSERT INTO GWASDISEASETRAITS (ID, DISEASETRAIT) VALUES (2, 'Acute lung injury');




-- GWASSTUDIES
INSERT INTO GWASSTUDIES (ID, PMID, DISEASEID)
VALUES (1, '21044949', 1);
INSERT INTO GWASSTUDIES (ID, PMID, DISEASEID)
VALUES (2, '22295056', 2);

-- GWASASSOCIATIONS
INSERT INTO GWASASSOCIATIONS (ID, STUDYID, SNP)
VALUES (16617, 1, 'rs7329174');
INSERT INTO GWASASSOCIATIONS (ID, STUDYID, SNP)
VALUES (16618, 2, 'rs7329174');
...
--
-- -- GWASSTUDIES
-- INSERT INTO GWASSTUDIES (ID, AUTHOR, STUDYDATE, PUBLICATION, TITLE, INITSAMPLESIZE, REPLICSAMPLESIZE, PLATFORM, PMID, CNV, GXE, GXG, DISEASEID, HOUSEKEEPINGID)
-- VALUES (1, 'Yang J','2010-11-02 00:00:00', 'Hum Mol Genet','ELF1 is associated with systemic lupus erythematosus in Asian populations','612 Chinese ancestry cases, 1,160 Chinese ancestry controls','2,090 Chinese ancestry cases, 1,981 Chinese ancestry controls, 462 Thai ancestry cases, 951 Thai ancestry controls','Illumina [513,108]', '21044949', '1', '0', '1', 1,1);
-- INSERT INTO GWASSTUDIES (ID, AUTHOR, STUDYDATE, PUBLICATION, TITLE, INITSAMPLESIZE, REPLICSAMPLESIZE, PLATFORM, PMID, CNV, GXE, GXG, DISEASEID, HOUSEKEEPINGID)
-- VALUES (2, 'Christie JD','2012-01-25 00:00:00', 'PLoS Onet','Genome wide association identifies PPFIA1 as a candidate gene for acute lung injury risk following major trauma','600 European ancestry cases, 2,266 European ancestry controls','212 European ancestry cases, 283 European ancestry controls','Illumina [2,487,415] (imputed)', '22295056', '0', '0', '0', 2,2);
--
-- -- GWASASSOCIATIONS
-- INSERT INTO GWASASSOCIATIONS (ID, STUDYID, SNP, STRONGESTALLELE, RISKFREQUENCY, ALLELE, PVALUEFLOAT, PVALUETXT, ORPERCOPYNUM, ORTYPE, SNPTYPE, PVALUE_MANTISSA, PVALUE_EXPONENT, ORPERCOPYRECIP, ORPERCOPYSTDERROR, ORPERCOPYRANGE, ORPERCOPYUNITDESCR) VALUES (16617, '1', 'rs7329174', 'rs7329174-G', '0.22', 'G', 1E-8, 'NULL', 1.26, '1','Novel', 1, -8, null, null,'[1.16-1.36]', 'NULL');
