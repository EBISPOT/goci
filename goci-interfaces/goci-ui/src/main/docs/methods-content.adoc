...
* SNPs assayed or analyzed were limited to those in candidate genes.
...
GWAS Catalog data are manually extracted from the published paper (either the main text or supporting information) by expert scientists.
