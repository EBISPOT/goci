...
=== Try our new spreadsheet download [big red yellow-background]*BETA*

The GWAS Catalog with added mapping information is link:../api/search/downloads/ensembl_mapping[available for download here]
We'd love to hear any feedback about this new download, contact the GWAS Catalog team on mailto:gwas-info@ebi.ac.uk[gwas-info@ebi.ac.uk]
