...
https://www.ebi.ac.uk/data-protection/privacy-notice/gwas-catalog-confluence[GWAS Catalog Curation Tracking] applies to any publication-specific data (including author names, e-mail and address) that is being retained to help curators actually get data through the curation process.
