...
34. <<faq-34,How is the genomic annotation for each SNP provided?>>

35. <<faq-35,What changes will I see in the genomic annotation with the new mapping pipeline?>>
...
==== [[faq-34]]34. How is the genomic annotation for each SNP provided?
...
==== [[faq-35]]35. What changes will I see in the genomic annotation with the new mapping pipeline?
