...
public class AssociationController {
    ...
    public String uploadStudySnps(@RequestParam("file") MultipartFile file, @PathVariable Long studyId, Model model)
        ...
        if (!file.isEmpty()) {
            ...
            Collection<BatchUploadError> uploadErrors = new ArrayList<>();
            try {
                uploadErrors = associationBatchLoaderService.processFile(uploadedFilePath, study);
            }
