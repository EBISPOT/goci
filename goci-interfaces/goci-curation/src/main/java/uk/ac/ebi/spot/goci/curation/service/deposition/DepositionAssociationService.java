...
public class DepositionAssociationService {
    ...
    @Transactional
    public Pair<Boolean, String> saveAssociation(SecureUser currentUser, Study study, DepositionAssociationDto associationDto, List<EfoTrait> efoTraits, String eRelease, ImportLog importLog) {
        ...
        if (StringUtils.isNotBlank(rsID)) {
            ...
            return Pair.of(Boolean.FALSE, studyNote.toString());
        }
        ...
        return Pair.of(Boolean.TRUE, studyNote.toString());
    }
}
