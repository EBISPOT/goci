...
--------------------------------------------------------
  ALTER TABLE "ASSOCIATION_EFO_TRAIT" ADD CONSTRAINT "ASSOCIATION_EFO_TRAIT_ID_UK" UNIQUE ("EFO_TRAIT_ID") ENABLE;
...
--------------------------------------------------------
  ALTER TABLE "ASSOCIATION_REPORTED_GENE" ADD CONSTRAINT "ASSOCIATION_REPORTED_GENE_ID_UK" UNIQUE ("REPORTED_GENE_ID") ENABLE;
...
--ALTER TABLE ASSOCIATION_REPORTED_GENE DISABLE CONSTRAINT ??;
--ALTER TABLE SNP_GENE DISABLE CONSTRAINT ??;
...
--------------------------------------------------------
-- Foreign key constraints!
--ALTER TABLE STUDY_SNP DISABLE CONSTRAINT ??;
--ALTER TABLE SNP_GENE DISABLE CONSTRAINT ??;
--ALTER TABLE ASSOCIATION_SNP DISABLE CONSTRAINT ??;
