...
public class OWLPussycatSessionFactory implements PussycatSessionFactory {
    ...
    private ReasonerSession createReasonerSession() {
        ...
        //        a) we are dynamically generating the knowledgebase (uk.ac.ebi.spot.goci.pussycat.reasoning.DataPublishingCacheableReasonerSession) or
        //        b) statically loading a precanned version (uk.ac.ebi.spot.goci.pussycat.reasoning.OntologyLoadingCacheableReasonerSession) or
        //        c) never recalculating SVG and only loading from cache (uk.ac.ebi.spot.goci.pussycat.reasoning.OntologyReasonerSession) -->
        //        <bean id="reasonerSession"
        //        class="uk.ac.ebi.spot.goci.pussycat.reasoning.OntologyReasonerSession"
        //        init-method="init">
