...
################################################################################
Migration script to standardise the use of dates in the STUDY and HOUSEKEEPING
tables and the CATALOG_SUMMARY_VIEW
...
ALTER TABLE STUDY RENAME COLUMN STUDY_DATE TO PUBLICATION_DATE;
...
ALTER TABLE HOUSEKEEPING RENAME COLUMN PUBLISH_DATE TO CATALOG_PUBLISH_DATE;
