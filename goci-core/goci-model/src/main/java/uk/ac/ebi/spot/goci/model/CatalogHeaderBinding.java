...
public enum CatalogHeaderBinding {
    ...
    INITIAL_SAMPLE_DESCRIPTION("INITIAL_SAMPLE_DESCRIPTION",
                               ...
                               new Inclusion.FieldIncluded("INITIAL SAMPLE DESCRIPTION"),
                               new Inclusion.Excluded()),
    REPLICATE_SAMPLE_DESCRIPTION("REPLICATE_SAMPLE_DESCRIPTION",
                                 new Inclusion.FieldIncluded("REPLICATION SAMPLE SIZE"),
                                 new Inclusion.FieldIncluded("REPLICATION SAMPLE DESCRIPTION"),
                                 new Inclusion.Excluded()),
    REGION("REGION",
    ...
    REPORTED_GENE("REPORTED_GENE",
                  new Inclusion.FieldIncluded("REPORTED GENE(S)"),
                  new Inclusion.FieldIncluded("REPORTED GENE(S)"),
                  new Inclusion.Excluded()),
    ...
    DOWNLOAD_MAPPED_GENE(new Inclusion.Excluded(),
                         new Inclusion.FieldIncluded("MAPPED_GENE"),
                         new Inclusion.Excluded()),
    ...
    P_VALUE(new Inclusion.FieldIncluded("P-VALUE"),
            new Inclusion.FieldIncluded("P-VALUE"),
            new Inclusion.Excluded()),
    ...
    SPREADSHEET_CI(new Inclusion.FieldIncluded("95% CI (TEXT)"),
                   new Inclusion.FieldIncluded("95% CI (TEXT)"),
                   new Inclusion.Excluded()),
    PLATFORM("PLATFORM",
    ...
    ASSOCIATION_ID("ASSOCIATION_ID",
                   new Inclusion.FieldIncluded("GWASTUDIESSNPID"),
                   new Inclusion.Excluded(),
                   new Inclusion.FieldIncluded("studies_snp_id")),
    STUDY_ID("STUDY_ID",
             new Inclusion.FieldIncluded("GWASTUDYID"),
             new Inclusion.Excluded(),
    ...
    NCBI_NORMALISED_FIRST_AUTHOR("NCBI_NORMALIZED_FIRST_AUTHOR",
                                 new Inclusion.Excluded(),
                                 new Inclusion.Excluded(),
                                 new Inclusion.FieldIncluded("normalized_author_first")),
    ...
    EFO_TRAIT("EFO_TRAIT",
              new Inclusion.Excluded(),
              new Inclusion.FieldIncluded("MAPPED_TRAIT"),
              new Inclusion.Excluded()),
    EFO_URI("EFO_URI",
            new Inclusion.Excluded(),
            new Inclusion.FieldIncluded("MAPPED_TRAIT_URI"),
            new Inclusion.Excluded());
