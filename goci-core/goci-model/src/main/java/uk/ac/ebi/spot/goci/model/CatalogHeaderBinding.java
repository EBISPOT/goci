...
public enum CatalogHeaderBinding {
    ...
    INITIAL_SAMPLE_DESCRIPTION("INITIAL_SAMPLE_DESCRIPTION", "INITIAL SAMPLE SIZE", "INITIAL SAMPLE SIZE", false),
    ...
    DOWNSTREAM_GENE_DISTANCE("DOWNSTREAM_GENE_DISTANCE", false, "DOWNSTREAM GENE DISTANCE", "downstream_gene_distance"),
    ...
    NCBI_FIRST_UPDATE_DATE("NCBI_FIRST_UPDATE_DATE", false, false, false),
