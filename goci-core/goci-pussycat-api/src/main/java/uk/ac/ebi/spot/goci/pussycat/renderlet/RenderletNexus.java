...
public interface RenderletNexus {
    ...
    /**
     * Gets a string of SVG to be rendered.  This returns the most recent aggregated version of the SVG that has been
     * produced by all rendering events since this renderlet nexus was created or reset.
     *
    ...
    /**
     * Clears all rendering events that this nexus has been notified of.  This ensures a clean rendering can be
     * produced.
     */
    void reset();
}
