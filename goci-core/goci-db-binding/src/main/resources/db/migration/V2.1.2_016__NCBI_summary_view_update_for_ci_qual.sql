...
data to NCBI, including taking account of beta values
...
CREATE OR REPLACE VIEW NCBI_CATALOG_SUMMARY_VIEW (
  ...
  (CASE WHEN a.OR_PER_COPY_NUM IS NOT NULL THEN a.OR_PER_COPY_NUM ELSE a.BETA_NUM END) AS OR_BETA,
  a.RANGE AS CI,
    (CASE WHEN a.BETA_UNIT IS NOT NULL AND a.BETA_DIRECTION IS NOT NULL THEN CONCAT(CONCAT(a.BETA_UNIT,' '), a.BETA_DIRECTION) ELSE a.DESCRIPTION END) AS CI_QUALIFIER,
  p.MANUFACTURER,
  s.QUALIFIER,
  s.SNP_COUNT,
  s.IMPUTED,
