...
--------------------------------------------------------
  ALTER TABLE "ANCESTRY_ANCESTRAL_GROUP" ADD CONSTRAINT "ANCESTRY_ANCESTRAL_GROUP_ID_FK" FOREIGN KEY ("ANCESTRAL_GROUP_ID")
	  REFERENCES "ANCESTRAL_GROUP" ("ID") ENABLE;
  ALTER TABLE "ANCESTRY_ANCESTRAL_GROUP" ADD CONSTRAINT "ANCESTRY_ANCESTRAL_GROUP_ANCESTRY_ID_FK" FOREIGN KEY ("ANCESTRY_ID")
