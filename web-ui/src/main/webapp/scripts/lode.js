...
(function($) {
    ...
    var lodestarDiv = $("<div id='lodestar-main'></div>");
    var contentsDiv = $("<div id='lodestar-contents'></div>");
    var errorDiv = $('<div id="error-div" style="display: none;"/>');
    errorDiv.append($("<p class='alert'>Error</p>").append($("<span id='error-text'></span>")));

    var appdetails = $('<div id="lodestar-description"/>')
        .append($("<p></p>")
...
function _buildSparqlPage(element) {
    ...
    var sparqlForm = $("<form id='lodestar-sparql-form' name='lode-star-sparql form' action='#lodestart-sparql-results' method='GET'></form>");
...
//    fieldSet.append($("<legend>Enter SPARQL Query</legend>"));
    ...
    section1.append(
        $("<p></p>").append("<input type='button' style='display: inline;'  onclick='submitQuery()' value='Submit Query' class='submit' />")
    );
    section1.append(
        $("<p></p>").append("<input type='button' style='display: inline;' onclick='reloadPage()' value='Reset' class='submit' />")
    );
