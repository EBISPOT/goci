 ...
 */
public class VirtuosoJNDIDatasourceProvider implements DatasourceProvider {
    private Logger logger = LoggerFactory.getLogger(getClass());

    private VirtuosoDataSource virtuosoSource = null;

    public VirtuosoJNDIDatasourceProvider() {
    ...
    public VirtuosoJNDIDatasourceProvider(String endpointUrl, int port) {
